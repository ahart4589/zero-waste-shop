...
class Landing extends Component {
  render(){
    return (
      <div style={{backgroundColor: 'black', backgroundImage: `url(${background})`, backgroundSize: 'cover', overflow:'auto'}}>
        {/* <img style={{maxHeight: '150px', width: '100vw', marginTop: '100px'}}src={background}/> */}
        <h2 style={{color:'#0AE2C1', padding: '20px', fontFamily: 'Yanone Kaffeesatz', fontSize: '70px', marginTop: '100px'}}>
